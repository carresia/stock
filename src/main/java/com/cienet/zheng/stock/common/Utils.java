...
//@Slf4j
//public class Utils {
//    public static String buildCrowdTestingSignData4special() throws Exception {
//        int id = 9;
//        String contact = "13187978088";
//        String conditions = "米粉";
//        String supplement = "supplement";
//        Map<Integer, Boolean> agrees = new HashMap<>();
//        agrees.put(1, true);
//        agrees.put(2, false);
...
//    }
//
//    public static String buildCrowdTestingSignData() throws Exception {
////        @ReqParam(value = "id", required = true) long id,
////        @ReqParam(value = "contact") String contact,
////        @ReqParam(value = "conditions") String matched,
////        @ReqParam(value = "supplement") String supplement,
////        @ReqParam(value = "agreeLicense") boolean agree,
////        @ReqParam(value = "questions") String survey)
...
//            int idIndex = getRandom(1, 3);
//            int agreeIndex = getRandom(1, 2);
//            stringBuilder.append(ids.get(idIndex)).append(",")
//                    .append(contact).append(",")
//                    .append(conditions).append(",")
//                    .append(supplement).append(",")
//                    .append(agrees.get(agreeIndex)).append(",")
...
//            int num = 1;
//            while (num < 50 + 1) {
//                sbTmp.append(num).append(",").append(answer.get(getRandom(0, 3))).append(",");
//                num++;
//            }
//            String tmp = sbTmp.toString();
//            String tmp_1 = tmp.substring(0, tmp.lastIndexOf(','));
//            sb.append(tmp_1).append("\n");
//            data++;
//        }
//        return sb.toString();
//    }
